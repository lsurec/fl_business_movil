...
import 'package:fl_business/displays/listado_Documento_Pendiente_Convertir/view_models/payment_convert_view_model.dart';
import 'package:fl_business/displays/listado_Documento_Pendiente_Convertir/views/payment_convert_view.dart';
...
class AmountConvertView extends StatelessWidget {
  const AmountConvertView({Key? key}) : super(key: key);

  static const String routeName = 'amountConvert';
  ...
  Widget build(BuildContext context) {
    ...
    final vmPayment = Provider.of<PaymentConvertViewModel>(context);
...
class _Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    //vier models
    final vm = Provider.of<AmountConvertViewModel>(context);
    final vmPayment = Provider.of<PaymentConvertViewModel>(context);
